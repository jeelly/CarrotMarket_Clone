...
(Request(Client -> Server), Response(Server -> Client) 등 더 자세한 API정보
https://toothsome-air-bb9.notion.site/API-8f31d598008a41ccace5e0e53b6915a6
